...
const ForgetPassword = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        await axios.post(`${configUrl.BASEURL}/api/v1/forgetPassword`, userInfo)
            .then(result => {
    ...
    return (
        <div className="bg-slate-200 rounded-xl py-5 mx-auto px-2" style={{ width: "60vw" }}>
            <h1 className="text-blue-500 text-3xl text-center">Forget Password</h1>
            {
            ...
            <form onSubmit={handleFormSubmit} className="my-5">
                ...
                <label className="form-control w-full max-w-lg mx-auto my-1">
                    ...
                    <input name="password" type="password" placeholder="new password" className="input input-bordered w-full max-w-lg" />
                </label>
            ...
            <Link to={"/login"} className="text-green-500 btn btn-ghost ms-14 ">LogIn</Link>
        </div>
    );
};
